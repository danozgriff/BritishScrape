...
complist = scraperwiki.sqlite.execute("select Company.TIDM, Company.Company from company inner join Signal_History on Company.Company = Signal_History.Company")
