...
#D-1
       ...
       d1list = scraperwiki.sqlite.execute("""select `TIDM`, `Price`, `Date` from Signal_History where tidm = '" + tidm + "' and strftime('%Y', date)= ?""", (str(d1date.month),) ) # and Date = Datetime('15/2/2016')")
